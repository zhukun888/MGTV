<template>
	<view class="home">
		...
		<view class="bottom">
			<view class="bottom_item" v-for="(item,index) in childlist.person" :key="index">
				<view class="left">
		...
		<view class="last">
			<view class="last_item" hover-class="change" v-for="(item,id) in childlist.children" :key="id" @click="navItemClick(item.id)">
				<view class="left">
